 ...
 * Görsel dil ana sayfa panelinin aynısı (kart zemini, ince hat, tabular rakam); yeni stil yok.
 */
...
export function BekleyenKonsultasyonOzetiKarti({ ozet }: { ozet: BekleyenOzeti | null }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ marginLeft: 'auto', fontSize: 13, fontWeight: 700, color: '#0F9B8E' }}>Takip et →</span>
    </a>
  )
}
