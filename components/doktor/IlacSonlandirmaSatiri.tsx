...
export default function IlacSonlandirmaSatiri({ bilgi, onKapat, devamHref }: {
  ...
  return (
    <div role="status" data-testid="ilac-sonlandirma-satiri" className="notya-alt-yuzer" style={{ position: 'fixed', left: 12, right: 12, bottom: 'calc(12px + env(safe-area-inset-bottom, 0px))', zIndex: 40, display: 'flex', justifyContent: 'center', pointerEvents: 'none' }}>
