    ...
    <div style={{ marginTop: 18, background: '#0D1C33', border: '1px solid rgba(251,191,36,0.28)', borderRadius: 16, padding: '14px 18px' }}>
      ...
      {liste.slice(0, 8).map((g) => (
        <button
          ...
          style={{ display: 'block', width: '100%', textAlign: 'left', background: 'rgba(255,255,255,0.04)', border: 'none', borderRadius: 10, padding: '8px 12px', marginBottom: 6, color: '#EDF1F7', fontSize: 13, cursor: 'pointer' }}
        >
