...
export const ONAM_KUTUPHANESI: OnamSablonu[] = [
  ...
  { kod: 'ssvd', ad: 'Sezaryen Sonrası Vajinal Doğum (SSVD) Danışmanlık ve Onam', olay: 'dogum', maddeler: ['Önceki kesi tipi ve sayısı değerlendirildi; SSVD adaylığı anlatıldı.', 'Uterus rüptürü riski (yaklaşık %0,5–1) ve acil sezaryen olasılığı anlatıldı.', 'Sürekli fetal monitörizasyon yapılacaktır.'], riskler: ['Uterus rüptürü', 'Acil sezaryen', 'Başarısız deneme'] },
