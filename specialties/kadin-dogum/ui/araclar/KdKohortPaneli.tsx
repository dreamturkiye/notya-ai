      ...
      <div style={{ borderRadius: 14, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        {v && !gorunen.length && (
          <div style={{ padding: '32px 18px', textAlign: 'center' }}>
            <div style={{ fontSize: 17, fontWeight: 700, color: CHROME_RENK.muted, marginBottom: 8 }}>{v.satirlar.length ? 'Bu filtrede hasta yok' : v.toplamHasta ? 'Geciken takip yok' : 'Henüz gebelik veya kadın sağlığı kaydı yok'}</div>
