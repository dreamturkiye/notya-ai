...
export default function GcPreopAraci() {
  ...
  return (
    <>
      ...
      <div style={gcStil.kutu}>
        <div style={gcStil.etiket}>Kontrol listesi özeti (karar desteği)</div>
        ...
        <TaslakNotu>TASLAK — pre-op kontrol listesi karar desteğidir; CAT/mMRC, doz ve ameliyathane planı yazılmaz.</TaslakNotu>
      </div>
    </>
  )
}
