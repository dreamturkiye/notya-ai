...
const KURALLAR: Array<{
...
}> = [
  {
    ...
    eylem: 'Hemen hava yolu protokolü / resüsitasyon ekibi. Portal mesajı ile yönetilmez.',
    oncelik: 'hemen',
  ...
  },
  {
    ...
    ad: 'Resüsitasyon ihtiyacı',
    eylem: 'Hemen resüsitasyon protokolü. Doz şeması hekim / protokol sorumluluğundadır.',
    oncelik: 'hemen',
    dipnot: { ref: 'ERC_TR', not: 'Resüsitasyon — doz hekim/protokol' },
  },
  {
    ...
    eylem: 'Hemen kanama kontrolü ve resüsitasyon. Sevk kararı hekimde.',
    oncelik: 'hemen',
  ...
  },
  {
    ...
    ad: 'Şok şüphesi',
    eylem: 'Hemen resüsitasyon / sıvı / neden değerlendirmesi. Tanı Notya yazmaz.',
    oncelik: 'hemen',
