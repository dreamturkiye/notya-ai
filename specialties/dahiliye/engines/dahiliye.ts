 ...
 */
export type Ref = 'TIHUD2023' | 'HARRISON' | 'TEMD_DM2026' | 'HT_UZLASI2025' | 'TEMD_HT2022' | 'TEMD_LIPID' | 'TEMD_TIROID2025' | 'TEMD_OBEZITE2024' | 'TEMD_OSTEO2025' | 'TEMD_RAMAZAN' | 'HSGM_HT2025' | 'HYP' | 'KETEM' | 'SGK' | 'ESC_SCORE2'
