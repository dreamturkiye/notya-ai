 ...
 */
export type Ref = 'TIHUD2023' | 'HARRISON' | 'TEMD_DM2026' | 'HT_UZLASI2025' | 'TEMD_HT2022' | 'TEMD_LIPID' | 'TEMD_TIROID2025' | 'TEMD_OBEZITE2024' | 'TEMD_OSTEO2025' | 'TEMD_RAMAZAN' | 'HSGM_HT2025' | 'HYP' | 'KETEM' | 'SGK' | 'ESC_SCORE2' | 'ESC_SCORE2_DIABETES' | 'ESC_SCORE2_OP' | 'STOPP_START_V3' | 'ACR_GUT2020' | 'EULAR_GUT2016'
export type Dipnot = { ref: Ref; not: string }
export const REF_ACIKLAMA: Record<Ref, string> = { TIHUD2023: 'TİHUD İç Hastalıkları 4. baskı (2023)', HARRISON: 'Harrison İç Hastalıkları Prensipleri 20 (TR)', TEMD_DM2026: 'TEMD Diyabet 2026', HT_UZLASI2025: 'Türk Hipertansiyon Uzlaşı Raporu 2025', TEMD_HT2022: 'TEMD Hipertansiyon 2022', TEMD_LIPID: 'TEMD Dislipidemi 2021', TEMD_TIROID2025: 'TEMD Tiroid 2025', TEMD_OBEZITE2024: 'TEMD Obezite 2024', TEMD_OSTEO2025: 'TEMD Osteoporoz 2025', TEMD_RAMAZAN: 'TEMD Ramazan ve Diyabet Rehberi', HSGM_HT2025: 'Sağlık Bakanlığı HSGM Hipertansiyon 2025', HYP: 'Halk Sağlığı Genel Müdürlüğü Yetişkin Hastalık Yönetim Platformu (HYP)', KETEM: 'Sağlık Bakanlığı KETEM ulusal kanser tarama programları', SGK: 'SGK Sağlık Uygulama Tebliği (SUT) — güncel metin hekim doğrular', ESC_SCORE2: 'SCORE2 working group & ESC Cardiovascular risk collaboration. SCORE2 risk prediction algorithms. Eur Heart J 2021;42:2439–54 (doi:10.1093/eurheartj/ehab309) — Updated Supplementary Material, Suppl. methods Tables 2–4', ESC_SCORE2_DIABETES: 'SCORE2-Diabetes working group & ESC Cardiovascular risk collaboration. SCORE2-Diabetes: 10-year cardiovascular risk estimation in type 2 diabetes in Europe. Eur Heart J 2023;44:2544–56 (doi:10.1093/eurheartj/ehad260) — Supplementary Methods Table 1 + Appendix 2 hesaplayıcı', ESC_SCORE2_OP: 'SCORE2-OP working group & ESC Cardiovascular risk collaboration. SCORE2-OP risk prediction algorithms. Eur Heart J 2021;42:2455–67 (doi:10.1093/eurheartj/ehab312) — Supplementary Methods Tables 1–3', STOPP_START_V3: 'O\'Mahony D, et al. STOPP/START criteria for potentially inappropriate prescribing in older people: version 3. Eur Geriatr Med 2023;14(4):625–32 (doi:10.1007/s41999-023-00777-y) — kurallar kendi sözcüklerimizle, sınıf düzeyinde', ACR_GUT2020: 'FitzGerald JD, et al. 2020 American College of Rheumatology Guideline for the Management of Gout. Arthritis Care Res 2020;72(6):744–60 (doi:10.1002/acr.24180)', EULAR_GUT2016: 'Richette P, et al. 2016 updated EULAR evidence-based recommendations for the management of gout. Ann Rheum Dis 2017;76(1):29–42 (doi:10.1136/annrheumdis-2016-209707)' }
...
export const SEVK_HEDEFLERI = ['kardiyoloji', 'endokrinoloji', 'nefroloji', 'gastroenteroloji', 'gogus', 'goz', 'uroloji', 'romatoloji', 'noroloji', 'fiziksel_tip', 'psikiyatri', 'sigara_birakma'] as const
