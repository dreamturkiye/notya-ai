...
export const GOZ_TOOLS = [
  ...
  { name: 'goz.goruntu_okuma', description: 'OCT / fundus / ön segment okuması: asistan taslağı, uzman onayı (dual-sign)' },
  { name: 'goz.kontrol', description: 'Portal kontrol hatırlatması' },
  { name: 'goz.pediatrik', description: 'Ambliyopi / şaşılık izlem hatırlatmaları' },
