        ...
        {photos.map((p) => {
          ...
          return (
            <li key={p.id} style={{ border: '1px solid rgba(255,255,255,0.08)', borderRadius: 10, padding: 8 }}>
              {kilit ? (
                <div style={{ height: 110, borderRadius: 8, background: 'rgba(248,113,113,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, color: '#FCA5A5', textAlign: 'center', padding: 8 }}>
