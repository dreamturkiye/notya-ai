...
kontrol('hafıza sesBlogu: göz kısa kilidi yüklendi, başka branş kilidi yok', /GÖZ/.test(hafiza.sesBlogu) && !/DAHİLİYE|KADIN DOĞUM|DERMATOLOJİ KİLİDİ/.test(hafiza.sesBlogu), String(hafiza.sesBlogu || '').slice(0, 300))
