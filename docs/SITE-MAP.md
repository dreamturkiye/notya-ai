...
- Kadın-doğum **Taburcu + NTP + Bebek izlem** (clinic checklist, not e-Nabız): `lib/clinical/yenidogan/*`, `/api/doktor/yenidogan`, KD Taburcu paketi + lohusa checklist, hasta dosyası **Bebek kartı** (`components/doktor/HastaBebekKarti.tsx`); NTP `lab_paneller.panel_type=yenidogan_tarama` on the **bebek** only; migration `029_yenidogan_taburcu.sql`. Docs: `docs/README_YENIDOGAN.md`.
