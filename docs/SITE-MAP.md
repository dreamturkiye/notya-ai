...
- Jinekoloji spine (NOTYA-JINE-01): `specialties/kadin-dogum/engines/jinekoloji-spine.ts`, API `/api/doktor/jinekoloji` (adim: kadin_sagligi|vizit|serviks|serviks_onayla|kolposkopi|cybh|pcos|lezyon|kontrasepsiyon|hrt|gorev; GET ?patientId=), UI `specialties/kadin-dogum/ui/JinekolojiSpine.tsx` in `components/doktor/HastaGebelik.tsx`; tables jine_vizitler, serviks_taramalari, cybh_episodlari, pcos_kartlari, lezyon_myom_kist, kontrasepsiyon, menopoz_hrt, jine_gorevleri (migration 030).
