...
|---|---|---|
| 2026-09-15 | **NOTYA-BLE-03 — ask Dr. Gökhan which Bluetooth device(s) he owns** (termometre marka/model; steteskop?) | First real pairing decides the first row of docs/CIHAZ-UYUMLULUK.md — the list grows only from field-paired devices (standing rule). |
