...
| NOTYA-AYSE-STANDART-05 | OPEN 2026-09-26 | 100-question expansion (~40 core + ~60 per branş), each with router pattern, evidence branch, template and fixture expectation. | Dr. Gökhan (question list) → Claude |
