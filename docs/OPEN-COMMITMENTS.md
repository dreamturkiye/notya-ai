...
| 2026-09-16 | **NOTYA-DAH-02 — reçete yazımı → hasta_ilaclar auto-update on the muayene; SCORE2 only if a reviewed formula lands; first real dahiliye patient (KB → lab → raporla → Onayla)** — waits on Claude / Kaan | — |
...
| 2026-09-16 | **NOTYA-JINE-03 — şiddet tarama: single checkbox + sevk on the yıllık kontrol; endometriyal örnekleme patoloji sonucu → Belgeler/Lab bridge; KOK yıllık TA/kilo görevi** — waits on Claude | Small follow-ups the V2 ticket named or implied. |
