...
| 2026-09-17 | **DAH-WOW-SMOKE-FU** — seen in smoke screenshots: check-up kalem "Kırılganlık + düşme taraması" not auto-ticked from dahiliye_taramalar; Bakım kalitesi bar keeps "Nota ekle" after the result was added. | OPEN (Claude) |
