...
export default function HomePage() {
  return (
    <main style={{margin:0,padding:0,background:"#FFFAFA",color:"#0A1628",
      ...
      <section id="özellikler" className="notya-grid-2 notya-section" style={{padding:"130px 48px",display:"grid",
      ...
      <section style={{position:"relative",overflow:"hidden",
        ...
        <div style={{position:"relative",zIndex:1,maxWidth:"1100px",margin:"0 auto"}}>
          ...
          {/* Before / After cards */}
          <div className="notya-grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"20px",maxWidth:"820px"}}>
      ...
      <section id="uzmanlar" style={{padding:"130px 48px",maxWidth:"1300px",margin:"0 auto"}}>
        ...
        <div className="notya-grid-3" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"20px"}}>
          {[
