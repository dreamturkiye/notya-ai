...
export default function MaliDashboard() {
  ...
  return (
    <>
      ...
      <div className='main-pad' style={{maxWidth:1200,margin:'0 auto',padding:"16px 12px"}}>
        ...
        <div className='main-grid' style={{display:'grid',gap:0}}>
          <div>
            {/* NOTES GRID */}
  ...
  @media (min-width:768px) {
    ...
    /* Mobile defaults - already set via class, no grid-template needed */
    ...
    @media (min-width:769px) {
      ...
      .main-grid  { grid-template-columns: 2fr 1fr; gap: 24px; }
