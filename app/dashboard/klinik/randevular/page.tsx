    ...
    <div style={{ minHeight: '100vh', background: '#FFFAFA', fontFamily: 'system-ui' }}>
      ...
      <div style={{ maxWidth: 880, margin: '0 auto', padding: '40px 24px' }}>
        ...
        <p style={{ color: 'rgba(10,22,40,0.55)', fontSize: 14, maxWidth: 640 }}>
          Klinik takvimi Doktor randevu ekranından ayrıdır. Koltuk ve Pabau bağlantısı Klinik Ayarları’nda.
        </p>
        <div style={{ marginTop: 24 }}>
          <Link href="/dashboard/klinik/pabau" style={{ color: '#2563EB', fontWeight: 600 }}>Pabau bağlantısı →</Link>
        </div>
      </div>
    </div>
  )
