...
export default function DoktorGiriş() {
      ...
      <div style={{background:"#111827",borderRadius:"20px",padding:"40px",maxWidth:"420px",width:"100%",border:"1px solid rgba(37,99,235,0.2)"}}>
        ...
        <form onSubmit={handleLogin} style={{display:"flex",flexDirection:"column",gap:"14px"}}>
          <div><label style={{fontSize:"13px",color:"#94a3b8",marginBottom:"6px",display:"block"}}>E-posta</label>
            <input type="email" required value={email} onChange={e=>setEmail(e.target.value)} placeholder="dr.ornek@hastane.com" style={inp}/></div>
