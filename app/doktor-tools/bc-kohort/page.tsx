...
export default function Page() {
  return (
    <BcAracKabugu route="/doktor-tools/bc-kohort" baslik="Beyin cerrahisi kohort paneli" aciklama="Geciken kontrol · post-op · bilinç · açık acil · görüntü — hasta-güvenli 1-tap hatırlatma.">
      <BcKohortAraci />
    </BcAracKabugu>
  )
}
