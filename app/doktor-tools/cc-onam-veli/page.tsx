...
export default function Page() {
  return (
    <CcAracKabugu route="/doktor-tools/cc-onam-veli" baslik="Onam / veli kontrol listesi" aciklama="Yaşa göre veli maddeleri. Yazılı onam klinik süreçtedir; canlı Medula e-imza yok.">
      <CcOnamVeliAraci />
    </CcAracKabugu>
  )
}
