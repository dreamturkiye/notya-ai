...
export default function Page() {
  return (
    <GastroAracKabugu route="/doktor-tools/gastro-kohort" baslik="Gastroenteroloji kohort paneli" aciklama="Geciken kontrol, skor/hepatit/endoskopi, PPI/biyolojik tarih ve açık acil bayraklı hastalar. Tek dokunuşla gönderilen hatırlatma tanı ve doz yazmaz.">
      <GastroKohortAraci />
    </GastroAracKabugu>
  )
}
