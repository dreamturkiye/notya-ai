...
export default function Page() {
  return (
    <NoroAracKabugu route="/doktor-tools/noro-kohort" baslik="Nöroloji kohort paneli" aciklama="Geciken kontrol, geciken ilaç izlem, açık inme/TIA bayrağı ve yüksek MIDAS bandı. Tek dokunuşla gönderilen hatırlatma klinik bilgi taşımaz.">
      <NoroKohortAraci />
    </NoroAracKabugu>
  )
}
