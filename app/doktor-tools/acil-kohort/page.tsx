...
export default function Page() {
  return (
    <AtAracKabugu route="/doktor-tools/acil-kohort" baslik="Acil Tıp kohort paneli" aciklama="Geciken kontrol · ESI 1–2 · kritik yol · sevk/taburcu · açık bayrak · 1-tap hatırlatma. Bed board HIS değildir.">
      <AtKohortAraci />
    </AtAracKabugu>
  )
}
