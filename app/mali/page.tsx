...
<section id="karsilastirma" style={{background:"var(--surface)",padding:"80px 48px"}}>
<div style={{maxWidth:"980px",margin:"0 auto"}}><h2 style={{textAlign:"center",fontSize:"clamp(24px,3vw,36px)",fontWeight:"700",fontFamily:"Merriweather,serif",color:"var(--text)",marginBottom:"36px",letterSpacing:"-0.02em"}}>Notya AI vs Diger Sistemler</h2>
<div style={{overflow:"auto"}}><table style={{width:"100%",borderCollapse:"collapse",fontFamily:"Lato,sans-serif",fontSize:"13px"}}><thead><tr style={{background:"var(--primary)"}}><th style={{padding:"13px 18px",textAlign:"left",color:"rgba(255,255,255,.7)",fontWeight:"700",fontSize:"12px"}}>Ozellik</th><th style={{padding:"13px",textAlign:"center",color:"#fff",fontWeight:"700"}}>Notya AI</th><th style={{padding:"13px",textAlign:"center",color:"rgba(255,255,255,.6)",fontWeight:"700"}}>ZEntegre</th><th style={{padding:"13px",textAlign:"center",color:"rgba(255,255,255,.6)",fontWeight:"700"}}>Parasut</th><th style={{padding:"13px",textAlign:"center",color:"rgba(255,255,255,.6)",fontWeight:"700"}}>Logo</th></tr></thead><tbody>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>AI belge analizi (fotograf/PDF)</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>WhatsApp ile belge gonderm</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Z raporu kars banka mutabakati</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Kira stopaj otomatik hesaplama</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Puantaj Excel otomatik okuma</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>KDV aritmetik otomatik kontrolu</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>MASAK risk skoru</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Sesli AI asistan (Turkce)</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Musteri portali</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Beyan takvimi + WhatsApp uyari</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Bordro hesaplayici</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>e-Beyan taslagi</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"var(--surface)"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Gorusme notu + risk skoru</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
<tr style={{borderBottom:"1px solid var(--border)",background:"#FAFBFA"}}><td style={{padding:"10px 18px",color:"var(--text)",fontWeight:"500"}}>Mevzuat takip (GIB otomatik)</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#1D9E75"}}>✔</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td><td style={{padding:"10px 13px",textAlign:"center",fontSize:"14px",color:"#D1D5DB"}}>✘</td></tr>
</tbody></table></div><p style={{textAlign:"center",marginTop:"14px",fontSize:"12px",color:"var(--text-muted)"}}>Rakip veriler kamuya acik kaynaklara dayanmaktadir. Haziran 2026.</p></div></section>
{/* FINAL CTA */}
