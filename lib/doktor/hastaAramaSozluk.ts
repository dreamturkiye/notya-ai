...
export const KLINIK_SOZLUK: Record<string, string[]> = {
  ...
  goz: ['goz', 'konjonktivit', 'kirmizi goz', 'capak', 'katarakt', 'glokom', 'oct', 'fundus'],
  ...
  diyabet: ['diyabet', 'seker', 'insulin', 'e10', 'e11'],
  ...
  jinekoloji: ['adet', 'menoraji', 'pcos', 'myom', 'endometriozis', 'menopoz', 'pap'],
  uroloji: ['prostat', 'bph', 'hematuri', 'inkontinans', 'bobrek tasi'],
  cilt: ['akne', 'psoriazis', 'melanom', 'sigil', 'zona', 'uyuz'],
