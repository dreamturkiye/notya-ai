...
export const SPECIALTIES: Specialty[] = [
  { key: "pediatri", label: "Pediatri", emoji: "👶", color: "#0F9B8E", references: ["Nelson Textbook of Pediatrics 22e", "Harriet Lane Handbook 23e", "T.C. Sağlık Bakanlığı GBP aşı takvimi", "Türk Pediatri Kurumu"], soapFields: ["ates", "kilo", "boy", "gelisim"], greeting: "Merhaba, ben Prof. Dr. Ayşe Kaya. Pediatri alanında size yardımcı oluyorum.", agentIdEnvVar: "GROQ_AGENT_PEDİATRİ" },
  { key: "kardiyoloji", label: "Kardiyoloji", emoji: "❤️", color: "#DC2626", references: ["Braunwald's Heart Disease 12e", "ESC Guidelines 2024", "Türk Kardiyoloji Derneği (TKD) kılavuzları"], soapFields: ["ekg", "ef", "nyha"], greeting: "Merhaba, ben Prof. Dr. Mehmet Demir. Kardiyoloji alanında size yardımcı oluyorum.", agentIdEnvVar: "GROQ_AGENT_KARDİYOLOJİ" },
  { key: "noroloji", label: "Nöroloji", emoji: "🧠", color: "#7C3AED", references: ["Adams & Victor's Neurology 12e", "Harrison's Principles 22e", "Türk Nöroloji Derneği / Türkiye İnme Kılavuzu"], soapFields: ["norolojik_muayene", "gcs", "kraniyal_sinirler"], greeting: "Merhaba, ben Prof. Dr. Elif Şahin. Nöroloji ve dahiliye alanında size yardımcı oluyorum.", agentIdEnvVar: "GROQ_AGENT_NÖROLOJİ" },
  { key: "dahiliye", label: "Dahiliye", emoji: "🩺", color: "#0F9B8E", references: ["Harrison's Principles 22e", "Goldman-Cecil Medicine 27e", "Washington Manual 38e"], soapFields: ["sistemik_muayene"], greeting: "Merhaba, ben Prof. Dr. Elif Şahin. Dahiliye ve nöroloji köprüsünde size yardımcı oluyorum.", agentIdEnvVar: "GROQ_AGENT_DAHİLİYE" },
