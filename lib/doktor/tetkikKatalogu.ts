/**
 * Audit note (2026-09-05): Cross-checked against Turkish hospital lab guides
 * (Ankara Üni., Erciyes, Başkent, devlet hastanesi test rehberleri) and common
 * private-lab panel naming (Düzen / Pakize Tarzı / E-Lab style). Names prefer
 * Turkish clinical usage; Latin/English abbreviations kept in parentheses where
 * labs print both (e.g. ESH / ESR, aPTT / APTZ, AKŞ).
 *
 * Tetkik kataloğu — Türkiye özel laboratuvarlarının test rehberi yapısıyla aynı bölümleme.
 * Her test: ad, numune, açlık gerekip gerekmediği, kısa not.
...
export const TETKIK_KATALOGU: TetkikBolumu[] = [
  { bolum: 'Rutin Biyokimya', testler: [
    t('Glukoz (açlık / AKŞ)', 'F', true), t('Glukoz (tokluk, 2. saat)', 'F'), t('HbA1c (glike hemoglobin)', 'E'), t('İnsülin (açlık)', 'S', true), t('C-peptid', 'S', true),
    t('Oral glukoz tolerans testi — OGTT 75 g (0-120 dk)', 'F', true), t('OGTT 50 g gebelik tarama', 'F'), t('HOMA-IR', 'S', true), t('Fruktozamin', 'S'),
    t('Üre', 'S'), t('Kreatinin', 'S'), t('eGFR (CKD-EPI)', 'S'), t('Ürik asit', 'S'), t('Sistatin C', 'S'),
    t('Total protein', 'S'), t('Albümin', 'S'), t('Protein elektroforezi', 'S'), t('İmmünfiksasyon elektroforezi', 'S'),
    t('AST (SGOT)', 'S'), t('ALT (SGPT)', 'S'), t('GGT', 'S'), t('ALP (alkalen fosfataz)', 'S'), t('LDH', 'S'), t('Total bilirubin', 'S'), t('Direkt bilirubin', 'S'), t('İndirekt bilirubin', 'S'),
    ...
    t('CRP', 'S'), t('hs-CRP', 'S'), t('Eritrosit sedimantasyon hızı (ESH)', 'E'), t('Prokalsitonin', 'S'), t('Ferritin', 'S'),
  ...
  { bolum: 'Elektrolit ve Mineraller', testler: [
    ...
    t('Bikarbonat (HCO₃)', 'S'), t('Çinko', 'S'), t('Bakır', 'S'), t('Seruloplazmin', 'S'), t('Selenyum', 'S'), t('Demir', 'S', true), t('Total demir bağlama kapasitesi (TDBK)', 'S', true), t('Transferrin', 'S'), t('Transferrin satürasyonu', 'S', true),
  ]},
  { bolum: 'Hematoloji', testler: [
    t('Tam kan sayımı (Hemogram)', 'E'), t('Periferik yayma', 'E'), t('Retikülosit', 'E'), t('Kan grubu ve Rh', 'E'), t('Direkt Coombs', 'E'), t('İndirekt Coombs', 'S'),
    t('Hemoglobin elektroforezi', 'E'), t('HbA2 / HbF', 'E'), t('G6PD', 'E'), t('Haptoglobin', 'S'), t('Ozmotik frajilite', 'H'), t('Kemik iliği aspirasyonu değerlendirmesi', 'D'), t('Akım sitometrisi (lösemi/lenfoma paneli)', 'E'),
    t('Trombosit fonksiyon testi (PFA-100)', 'C'),
  ]},
  { bolum: 'Koagülasyon', testler: [
    t('Protrombin zamanı (PT) / INR', 'C'), t('aPTT (APTZ)', 'C'), t('Fibrinojen', 'C'), t('D-Dimer', 'C'), t('Kanama zamanı', 'D'), t('Trombin zamanı', 'C'),
  ...
  { bolum: 'Tiroid', testler: [
    t('TSH', 'S'), t('Serbest T4 (sT4)', 'S'), t('Serbest T3 (sT3)', 'S'), t('Total T4', 'S'), t('Total T3', 'S'), t('Anti-TPO', 'S'), t('Anti-tiroglobulin (Anti-Tg)', 'S'), t('Tiroglobulin', 'S'), t('TSH reseptör antikoru (TRAb)', 'S'), t('Kalsitonin', 'S'),
  ]},
  { bolum: 'Üreme ve Gonad Hormonları', testler: [
    ...
    t('17-OH progesteron', 'S'), t('AMH (Anti-Müllerian hormon)', 'S'), t('İnhibin B', 'S'), t('β-hCG (kantitatif)', 'S'), t('hCG (kalitatif, idrar)', 'İ'), t('Semen analizi (spermogram)', 'D'),
  ]},
  ...
  { bolum: 'Vitaminler ve Kemik Metabolizması', testler: [
    t('25-OH Vitamin D', 'S'), t('1,25-(OH)₂ Vitamin D', 'S'), t('Vitamin B12', 'S'), t('Folat (folik asit)', 'S'), t('Eritrosit folat', 'E'), t('Vitamin A', 'S'), t('Vitamin E', 'S'), t('Vitamin B1 (tiamin)', 'E'), t('Vitamin B6', 'E'), t('Vitamin C', 'S'), t('Vitamin K', 'S'),
  ...
  { bolum: 'Kardiyak Belirteçler', testler: [
    t('Troponin I (hs)', 'S'), t('Troponin T (hs)', 'S'), t('CK-MB (kütle)', 'S'), t('Miyoglobin', 'S'), t('NT-proBNP', 'S'), t('BNP', 'E'),
  ]},
  { bolum: 'Tümör Belirteçleri', testler: [
    ...
    t('NSE', 'S'), t('CYFRA 21-1', 'S'), t('SCC', 'S'), t('HE4', 'S'), t('ROMA indeksi (CA125 + HE4)', 'S'), t('Kromogranin A', 'S'), t('β-hCG (tümör belirteci)', 'S'), t('Serbest hafif zincir kappa/lambda', 'S'), t('M2-PK (gaita)', 'G'),
  ]},
  ...
  { bolum: 'Enfeksiyon Serolojisi', testler: [
    ...
    t('Borrelia (Lyme) IgM/IgG', 'S'), t('Mycoplasma pneumoniae IgM/IgG', 'S'), t('Chlamydia pneumoniae IgM/IgG', 'S'), t('Chlamydia trachomatis IgM/IgG', 'S'), t('Anti-Kist hidatik (Echinococcus) IgG', 'S'), t('Anti-Leishmania', 'S'), t('Anti-Entamoeba histolytica', 'S'), t('Quantiferon TB Gold (IGRA)', 'H'), t('Tüberkülin deri testi (PPD)', 'D'),
  ]},
...
export const TETKIK_PANELLERI: Record<string, string[]> = {
  'Genel Check-up': ['Tam kan sayımı (Hemogram)', 'Glukoz (açlık / AKŞ)', 'HbA1c (glike hemoglobin)', 'Üre', 'Kreatinin', 'Ürik asit', 'AST (SGOT)', 'ALT (SGPT)', 'GGT', 'ALP (alkalen fosfataz)', 'Total kolesterol', 'LDL kolesterol', 'HDL kolesterol', 'Trigliserid', 'TSH', 'Vitamin B12', '25-OH Vitamin D', 'Ferritin', 'CRP', 'Tam idrar tetkiki (TİT)', 'Eritrosit sedimantasyon hızı (ESH)'],
  'Diyabet Takibi': ['Glukoz (açlık / AKŞ)', 'HbA1c (glike hemoglobin)', 'İnsülin (açlık)', 'C-peptid', 'Kreatinin', 'eGFR (CKD-EPI)', 'Mikroalbümin (spot idrar)', 'Albümin/kreatinin oranı (spot)', 'Total kolesterol', 'LDL kolesterol', 'HDL kolesterol', 'Trigliserid', 'ALT (SGPT)'],
  'Tiroid Paneli': ['TSH', 'Serbest T4 (sT4)', 'Serbest T3 (sT3)', 'Anti-TPO', 'Anti-tiroglobulin (Anti-Tg)'],
  'Lipid Paneli': ['Total kolesterol', 'LDL kolesterol', 'HDL kolesterol', 'Trigliserid', 'Non-HDL kolesterol', 'Lipoprotein (a)'],
  'Karaciğer Paneli': ['AST (SGOT)', 'ALT (SGPT)', 'GGT', 'ALP (alkalen fosfataz)', 'Total bilirubin', 'Direkt bilirubin', 'Albümin', 'Total protein', 'Protrombin zamanı (PT) / INR', 'HBsAg', 'Anti-HCV'],
  'Böbrek Paneli': ['Üre', 'Kreatinin', 'eGFR (CKD-EPI)', 'Ürik asit', 'Sodyum (Na)', 'Potasyum (K)', 'Kalsiyum (Ca)', 'Fosfor (P)', 'Tam idrar tetkiki (TİT)', 'Albümin/kreatinin oranı (spot)', 'Parathormon (PTH)'],
  'Anemi Paneli': ['Tam kan sayımı (Hemogram)', 'Periferik yayma', 'Retikülosit', 'Demir', 'Total demir bağlama kapasitesi (TDBK)', 'Ferritin', 'Vitamin B12', 'Folat (folik asit)', 'Hemoglobin elektroforezi', 'Haptoglobin'],
  'Hepatit Paneli': ['HBsAg', 'Anti-HBs', 'Anti-HBc total', 'Anti-HCV', 'Anti-HAV IgG (total)', 'Anti-HIV 1/2 (4. kuşak)'],
  'Preoperatif': ['Tam kan sayımı (Hemogram)', 'Protrombin zamanı (PT) / INR', 'aPTT (APTZ)', 'Glukoz (açlık / AKŞ)', 'Üre', 'Kreatinin', 'Sodyum (Na)', 'Potasyum (K)', 'AST (SGOT)', 'ALT (SGPT)', 'HBsAg', 'Anti-HCV', 'Anti-HIV 1/2 (4. kuşak)', 'Kan grubu ve Rh'],
  'Gebelik İlk Vizit': ['Tam kan sayımı (Hemogram)', 'Kan grubu ve Rh (gebelik)', 'İndirekt Coombs (gebelik)', 'Glukoz (açlık / AKŞ)', 'TSH', 'Tam idrar tetkiki (TİT)', 'İdrar kültürü + antibiyogram', 'HBsAg', 'Anti-HCV', 'Anti-HIV 1/2 (4. kuşak)', 'VDRL / RPR', 'TORCH paneli (Toxo/Rubella/CMV/HSV IgM-IgG)', 'Ferritin', 'Vitamin B12', '25-OH Vitamin D'],
  'Romatoloji Tarama': ['Tam kan sayımı (Hemogram)', 'Eritrosit sedimantasyon hızı (ESH)', 'CRP', 'Romatoid faktör (RF)', 'Anti-CCP', 'ANA (IFA)', 'Ürik asit', 'HLA-B27', 'Kompleman C3', 'Kompleman C4', 'Tam idrar tetkiki (TİT)'],
  'Kardiyak Risk': ['Troponin I (hs)', 'NT-proBNP', 'hs-CRP', 'Total kolesterol', 'LDL kolesterol', 'HDL kolesterol', 'Trigliserid', 'Lipoprotein (a)', 'Homosistein', 'HbA1c (glike hemoglobin)', 'Kreatinin'],
  ...
  'Erkek Hormon / İnfertilite': ['FSH', 'LH', 'Total testosteron', 'Serbest testosteron', 'SHBG', 'Prolaktin', 'Estradiol (E2)', 'Semen analizi (spermogram)', 'Semen kültürü'],
  'Enfeksiyon Tarama (ateş)': ['Tam kan sayımı (Hemogram)', 'CRP', 'Prokalsitonin', 'Eritrosit sedimantasyon hızı (ESH)', 'Kan kültürü (aerob/anaerob)', 'İdrar kültürü + antibiyogram', 'Tam idrar tetkiki (TİT)', 'Brucella (Rose Bengal)', 'Salmonella (Gruber-Widal)'],
}

function flattenUnique(): Tetkik[] {
  const seen = new Set<string>()
  const out: Tetkik[] = []
  for (const b of TETKIK_KATALOGU) {
    for (const x of b.testler) {
      if (seen.has(x.ad)) continue
      seen.add(x.ad)
      out.push(x)
    }
  }
...
export const TUM_TETKIKLER: Tetkik[] = flattenUnique()
export const TETKIK_BOLUMU = new Map<string, string>(
  TETKIK_KATALOGU.flatMap((b) => b.testler.map((x) => [x.ad, b.bolum] as [string, string]))
)
