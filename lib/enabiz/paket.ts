 ...
 *
 * SGK rapor kanonu: /doktor-tools/sgk-rapor (branş-agnostik; pediatri + genel
...
export const ENABIZ_ARTEFAKTLAR: {
  ...
  { tur: 'sgk_rapor', ad: 'SGK e-Rapor / e-İstirahat', kanal: 'medula_erapor_json', ornek: 'Araçlar → Hasta Raporları; Medula alan JSON' },
