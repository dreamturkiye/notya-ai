...
values ('054', '054_derm_exceptional.sql', null, now(), false, 'DERM-EXCEPTIONAL-01: skor bölge dökümü (ek jsonb) + SCORAD/IGA/BSA, fototerapi v2 (doz adımı, eritem, yanık protokolü) + derm_med_kayitlari, yama ICDRG dereceleri + ek seriler, kozmetik lot/komplikasyon, acil işaretleri + basamak kilidi + Behçet/büllöz izlem jsonb, derm_biyolojik_raporlar, derm_dermoskopi_skorlari')
