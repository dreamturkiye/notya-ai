...
export const SPECIALISTS: SpecialistDef[] = [
  {
    ...
    clinicalFocus: [
      ...
      'Ateş <3 ay / sepsis / meningizm → ÇAYD kırmızı bayrakları',
  ...
  },
  {
    ...
    clinicalFocus: [
      ...
      'Baş ağrısı: TND Migren protokolü — kırmızı bayraklar',
  ...
  },
  {
    ...
    clinicalFocus: [
      ...
      'Enfeksiyon (septik artrit) kırmızı bayrakları',
  ...
  },
  {
    ...
    gender: 'male',
    personality: 'Direkt, çözüm odaklı. Taş, enfeksiyon ve onkolojik kırmızı bayrakları kaçırmaz.',
  ...
  },
  {
    ...
    clinicalFocus: [
      ...
      'Seyahat / zoonoz / bağışıklığı baskılanmış hasta',
    ],
    voice: nextM(),
  ...
  },
  {
    ...
    clinicalFocus: [
      ...
      'Adrenal / hipofiz kırmızı bayrakları',
    ],
    voice: nextF(),
  ...
  },
  {
    ...
    clinicalFocus: [
      ...
      'Organ tutulumu kırmızı bayrakları',
    ],
    voice: nextF(),
  ...
  },
  {
    ...
    clinicalFocus: [
      ...
      'Palyatif / destek tedavi zamanlaması',
    ],
    voice: nextF(),
  ...
  },
  {
    ...
    gender: 'female',
    personality: 'Performans + güvenlik. Spora dönüş kararını titizlikle verir.',
    ...
    clinicalFocus: [
      ...
      'Konküzyon / spora dönüş',
      'Aşırı kullanım (overuse) yaralanmaları',
      'Egzersiz reçetesi ve kardiyak kırmızı bayraklar (sporcu ani ölüm riski)',
    ],
    voice: nextF(),
