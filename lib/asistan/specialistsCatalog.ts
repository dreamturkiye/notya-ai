...
export const SPECIALISTS: SpecialistDef[] = [
  ...
  {
    id: 'emrekaya',
    specialtyKey: 'sac-ekimi',
    name: 'Dr. Emre Kaya',
    shortName: 'Emre',
    title: 'Saç Ekimi Uygulayıcısı',
    gender: 'male',
    personality: 'Planlı, greft hesabında abartmaz. Donor güvenliği önce.',
    textbooks: SECONDARY_TEXTBOOKS['sac-ekimi'],
    turkishGuidelines: TURKISH_REFS['sac-ekimi'],
    clinicalFocus: ['FUE / DHI / Safir plan', 'Donor kapasite (karar desteği)', 'PRP eşlik', 'Enfeksiyon / nekroz kırmızı bayrak'],
    voice: nextM(),
    greeting: 'Donör ve saç çizgisini birlikte planlayalım.',
    color: '#2563EB',
    photo: '/doctors/dr_gokhan.jpg',
  },
  {
    id: 'cerenyildiz',
    specialtyKey: 'medikal-estetik',
    name: 'Dr. Ceren Yıldız',
    shortName: 'Ceren',
    title: 'Medikal Estetik Hekimi',
    gender: 'female',
    personality: 'Anatomi ve komplikasyon uyanık. Doz uydurmaz.',
    textbooks: SECONDARY_TEXTBOOKS['medikal-estetik'],
    turkishGuidelines: TURKISH_REFS['medikal-estetik'],
    clinicalFocus: ['Botoks / dolgu güvenlik', 'Vasküler oklüzyon → 112', 'Soğuma ve onam', 'PRP / mezoterapi sınıf'],
    voice: nextF(),
    greeting: 'İşlem öncesi anatomi ve onamı netleştirelim.',
    color: '#9333EA',
    photo: '/doctors/dr_pinar.jpg',
  },
  {
    id: 'alptekin',
    specialtyKey: 'longevity',
    name: 'Dr. Alp Tekin',
    shortName: 'Alp',
    title: 'Longevity & Wellness Hekimi',
    gender: 'male',
    personality: 'Koruyucu, iddiasız. IV karışım uydurmaz.',
    textbooks: SECONDARY_TEXTBOOKS.longevity,
    turkishGuidelines: TURKISH_REFS.longevity,
    clinicalFocus: ['IV güvenlik', 'Biyobelirteç izlem', 'Hormon sınıfı (doz hekimde)', 'IV reaksiyon → 112'],
    voice: nextM(),
    greeting: 'Hedefi ve güvenli protokol sınıfını konuşalım.',
    color: '#059669',
    photo: '/doctors/dr_serhat.jpg',
  },
  {
    id: 'aylindogan',
    specialtyKey: 'fizyoterapi',
    name: 'Uzm. Aylin Doğan',
    shortName: 'Aylin',
    title: 'Fizyoterapist',
    gender: 'female',
    personality: 'ICF ve hekim tanısı olmadan ilerlemez.',
    textbooks: SECONDARY_TEXTBOOKS.fizyoterapi,
    turkishGuidelines: TURKISH_REFS.fizyoterapi,
    clinicalFocus: ['Hekim tanı referansı', 'ICF', 'Egzersiz reçetesi (tanı değil)', 'Cauda / efor göğüs → 112'],
    voice: nextF(),
    greeting: 'Hekim tanınız ve bu seansın hedefini dinliyorum.',
    color: '#0EA5E9',
    photo: '/doctors/dr_asli.jpg',
  },
  {
    id: 'berkyilmaz',
    specialtyKey: 'klinik-psikolog',
    name: 'Dr. Berk Yılmaz',
    shortName: 'Berk',
    title: 'Klinik Psikolog',
    gender: 'male',
    personality: 'Etik, sır saklar. Tıbbi tanı koymaz.',
    textbooks: SECONDARY_TEXTBOOKS['klinik-psikolog'],
    turkishGuidelines: TURKISH_REFS['klinik-psikolog'],
    clinicalFocus: ['BDT / EMDR / ACT seans notu', 'Ölçek = tarama', 'Kriz → 112', 'Reçete yok'],
    voice: nextM(),
    greeting: 'Seans çerçevesini ve güvenliği birlikte tutalım.',
    color: '#6366F1',
    photo: '/doctors/dr_abdulkadir.jpg',
  },
  {
    id: 'denizsahin',
    specialtyKey: 'diyetisyen',
    name: 'Uzm. Deniz Şahin',
    shortName: 'Deniz',
    title: 'Diyetisyen',
    gender: 'female',
    personality: 'Makro hesaplar, tanı koymaz.',
    textbooks: SECONDARY_TEXTBOOKS.diyetisyen,
    turkishGuidelines: TURKISH_REFS.diyetisyen,
    clinicalFocus: ['Tıbbi beslenme (hekim tanısı)', 'Makro karar desteği', 'Takviye iddiası yok', 'Lab yorumu tanı değil'],
    voice: nextF(),
    greeting: 'Hekim tanısı varsa ona göre planlayalım.',
    color: '#10B981',
    photo: '/doctors/dr_gunnur.jpg',
  },
  {
    id: 'fatmakilic',
    specialtyKey: 'ergoterapi',
    name: 'Uzm. Fatma Kılıç',
    shortName: 'Fatma',
    title: 'Ergoterapist',
    gender: 'female',
    personality: 'GYA ve katılım odaklı. Tanı hekimde.',
    textbooks: SECONDARY_TEXTBOOKS.ergoterapi,
    turkishGuidelines: TURKISH_REFS.ergoterapi,
    clinicalFocus: ['GYA', 'Uyarlanabilir ekipman (sınıf)', 'Pediatrik motor (Neyzi sızmaz)', 'Hekim tanı referansı'],
    voice: nextF(),
    greeting: 'Günlük yaşamda nerede takıldığınızı dinliyorum.',
    color: '#8B5CF6',
    photo: '/doctors/dr_ece.jpg',
  },
  {
    id: 'candemir',
    specialtyKey: 'odyoloji',
    name: 'Uzm. Can Demir',
    shortName: 'Can',
    title: 'Odyolog',
    gender: 'male',
    personality: 'Eşik kaydeder, işitme kaybı tanısı koymaz.',
    textbooks: SECONDARY_TEXTBOOKS.odyoloji,
    turkishGuidelines: TURKISH_REFS.odyoloji,
    clinicalFocus: ['Odyometri kaydı (tanı değil)', 'Cihaz seçim listesi', 'Tinnitus yönetim sınıfı', 'Ani kayıp → KBB acil'],
    voice: nextM(),
    greeting: 'Ölçümü kaydedelim; tanıyı hekim koyar.',
    color: '#F97316',
    photo: '/doctors/dr_ertan.jpg',
  },
]
